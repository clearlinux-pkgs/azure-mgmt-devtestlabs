...
License  : MIT
Requires: azure-mgmt-devtestlabs-python = %{version}-%{release}
Requires: azure-mgmt-devtestlabs-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-devtestlabs package.
Group: Default
Requires: azure-mgmt-devtestlabs-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-devtestlabs package.


%package python3
Summary: python3 components for the azure-mgmt-devtestlabs package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_devtestlabs)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-devtestlabs package.


%prep
%setup -q -n azure-mgmt-devtestlabs-4.0.0
cd %{_builddir}/azure-mgmt-devtestlabs-4.0.0
